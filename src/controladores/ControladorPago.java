...
public class ControladorPago implements ActionListener, ListSelectionListener {
	...
	public ControladorPago(vista.Pago vistaPago,Ida ida, IdaVuelta idaVuelta) {
	...
	private String getPrecio() {
		if (ventanaIda != null) {
			return ventanaIda.getPrecioIda().getText();	
		}
		return idaVuelta.getPrecioIda2().getText();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		switch (accion){
			...
			case BtnSiguiente:
				...
				Final vistaDevolucion = new Final();
			...
			case BtnPagar:
				...
				dineroRestanteFloat=(float) ((float) Math.round(Float.parseFloat(dineroRestante)*100)/100d);	
				dineroIntroducido=vistaPago.getTxtCantidadIngresada().getText().toString();
				dineroIntroducidoFloat=(float) ((float) Math.round(Float.parseFloat(dineroIntroducido)*100)/100d);
	...
	public void mostrarPrecio() {
		String precioIda = this.ventanaIda.getPrecioIda().getText().toString();
		
		this.vistaPago.getTxtRestante().setText(precioIda);
		this.vistaPago.getTxtTotal().setText(precioIda);

	}
	public void mostrarPrecioVuelta() {
		String precioIdaVuelta = this.idaVuelta.getPrecioIda2().getText().toString();
		
		this.vistaPago.getTxtRestante().setText(precioIdaVuelta);
		this.vistaPago.getTxtTotal().setText(precioIdaVuelta);
